...
def sortByDisease():
    ...
    f.writerow("The number of people with Diabetes is ",diabetes)
    f.writerow("The number of people with Abnormal Blood Pressure is ",bp)
    f.writerow("The number of people with Respiratory illness is ",ri)
    f.close()
